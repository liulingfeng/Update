...
import com.llf.update.MyApplication;
...
public class OkHttpUtil {
    ...
    private OkHttpUtil() {
        ...
        if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())) {
            File sdcache = MyApplication.instance.getExternalCacheDir();
    ...
    // 异步请求返回string到主线程
    public void _postAsyn(String url, String name, String version,boolean hasnet, StringCallback callback) {
        Request request = null;
        FormEncodingBuilder builder = new FormEncodingBuilder();
        builder.add("appName", name);
